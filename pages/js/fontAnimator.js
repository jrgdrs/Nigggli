        ...
        const words = [
            'dream', 'light', 'time', 'space', 'future', 'mind', 'truth', 'fire', 'stone', 'river', 'wind', 'shadow', 'echo', 'path', 'voice', 'heart', 'storm', 'memory', 'wave', 'field', 'Nigggli', 
            'sky', 'seed', 'thought', 'ocean', 'spark', 'dreamer', 'moment', 'vision', 'silence', 'forest', 'sound', 'cloud', 'mountain', 'dust', 'feather', 'flame', 'story', 'dreams', 'hope', 'tactile', 'Nigggli', 
            'soul', 'energy', 'mirror', 'night', 'day', 'world', 'circle', 'magic', 'shape', 'flow', 'Nigggli'
        ];
        ...
        const fontVariants = ['Nigggli-Light', 'Nigggli-Book', 'Nigggli-Regular', 'Nigggli-SemiBold', 'Nigggli-Bold', 'Nigggli-ExtraBold'];
